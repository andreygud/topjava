...
public class MealsUtil {
    ...
    public static final List<Meal> MEALS2 = Arrays.asList(
            new Meal(LocalDateTime.of(2019, Month.APRIL, 20, 20, 0), "Ужин", 510),
            new Meal(LocalDateTime.of(2019, Month.APRIL, 15, 12, 0), "Обед", 510),
            new Meal(LocalDateTime.of(2019, Month.APRIL, 18, 10, 0), "Ужин", 510)
    );
