...
public class Meal extends AbstractBaseEntity {
    ...
    @NotNull(groups = {JdbcBasicValidation.class, Default.class})
    private LocalDateTime dateTime;

    @Column(name = "description", nullable = false)
    @NotBlank(groups = {JdbcBasicValidation.class, Default.class})
    @Size(min = 2, max = 120)
    private String description;

    @Column(name = "calories", nullable = false)
    @Range(min = 10, max = 5000, groups = {JdbcBasicValidation.class, Default.class})
